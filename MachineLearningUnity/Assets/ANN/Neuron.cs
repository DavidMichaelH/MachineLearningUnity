...
namespace Ann
{
    ...
    public class Neuron
    {
        ...
        public Neuron(int numInputs, double bias, List<double> weights, Activations.Activation activationFunction)
        {
            // Validate input
            if (numInputs <= 0)
            {
        ...
        public Neuron(int numInputs, Activations.Activation activationFunction = Activations.Activation.Sigmoid) : this(numInputs, UnityEngine.Random.Range(-1f, 1f), new List<double>(), activationFunction)
        {
